...
export default function Creators() {
  ...
  return (
    <main className="container" style={{ paddingTop: 24, paddingBottom: 48 }}>
      <h1 style={{ fontSize: 24, marginBottom: 8 }}>নির্মাতারা</h1>
      <p className="text-muted" style={{ marginBottom: 24 }}>
        যিনি বানিয়েছেন, তার গল্পটাও জানুন।
      </p>
        ...
        {creators.map((c) => (
          <Link key={c.id} to={'/creator/' + c.id} className="card" style={{ padding: 16, display: 'flex', gap: 16 }}>
            ...
            <div>
              ...
              <div className="caption" style={{ marginTop: 4 }}>{c.creationsCount} সৃষ্টি · {c.followers} অনুসরণকারী</div>
              {c.verified && <span className="badge badge-verified" style={{ marginTop: 6 }}>যাচাইকৃত</span>}
            </div>
          </Link>
        ))}
      </div>
